...
def main():
    ...
    output_folder = "/home/matthewcockayne/Documents/PhD/zero-shot-segmentation-results/CAM-SAM-finetuned/"
    os.makedirs(output_folder, exist_ok=True)
    
    sam_model = "vit_h"  
    sam_checkpoint = "./results/model_checkpoints/sam_vit_h_4b8939.pth"
